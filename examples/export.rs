...
fn main() {
    ...
    let stream_0_0 = fs::File::open("examples/outputs/v0.0.cy").unwrap();
    let stream_0_1 = fs::File::open("examples/outputs/v0.1.cy").unwrap();
    let stream_0_2 = fs::File::open("examples/outputs/v0.2.cy").unwrap();

    let project_0_0 = File::open(stream_0_0).unwrap();
    let project_0_1 = File::open(stream_0_1).unwrap();
    let project_0_2 = File::open(stream_0_2).unwrap();
